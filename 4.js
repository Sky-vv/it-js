...
console.log(_.isEqual(f, g), '- Задание 5 - использование Lodash');
console.log(_.isEqual(f, h), '- Задание 5 - использование Lodash');
console.log(_.isEqual(f, j), '- Задание 5 - использование Lodash');
